                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM jewelry order by d_id desc";
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from collections where rs_id='".$rows['rs_id']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/jewelry/'.$rows['img'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div></td>
