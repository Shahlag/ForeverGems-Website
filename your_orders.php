                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="collections.php">Restaurants <span class="sr-only"></span></a> </li>
        ...
        <div class="bottom-footer">
            ...
            <div class="row">
                <div class="col-12 text-center color-gray">
                    <p>Copyright © 2024, Forever Gems Jewelry. All rights reserved. See our terms of use and privacy notice.</p>
                </div>
            </div>
        </div>
    </div>
